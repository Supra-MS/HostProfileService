...
const SvgSecurity = () => {
  return (
    <svg className="sec-svg" viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false" style={{ "height": "37px", "width": "32px", "display": "block", "fill": "rgb(255, 180, 0)" }}
